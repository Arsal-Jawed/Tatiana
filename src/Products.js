        ...
        <div className="flex flex-row mt-[4vh] w-[38vw]">
            <div className='relative w-[10vw] h-[12vh] overflow-hidden' style={{ borderRadius: '0.6vw' }}>
                ...
                {props.itemImage ? (
                    ...
                    <div className='w-full h-full bg-gray-200 flex items-center justify-center cursor-pointer' style={{ borderRadius: '0.6vw' }}>
                        <span className='text-gray-500 text-[1vw] text-center'>No Image</span>
                    </div>
                )}
